...
Command: npx gltfjsx@6.2.16 public/models/ferrari2.glb 
Author: Lexyc16 (https://sketchfab.com/Lexyc16)
License: CC-BY-NC-4.0 (http://creativecommons.org/licenses/by-nc/4.0/)
Source: https://sketchfab.com/3d-models/free-rossa-gt-lm-prototype-2023-d37778f32a67458689022b3f92b49228
Title: [FREE] Rossa GT LM Prototype 2023
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function Ferrari2(props) {
  const { nodes, materials } = useGLTF('./models/ferrari2.glb')
  return (
    <group {...props} dispose={null}>
      <group rotation={[-Math.PI / 2, 0, 0]}>
        ...
        <lineSegments geometry={nodes.Object_4.geometry} material={materials.glass_op0} />
...
useGLTF.preload('./models/ferrari2.glb')
