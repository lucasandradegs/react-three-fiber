...
Command: npx gltfjsx@6.2.16 public/models/colored6.glb 
*/

import React, { useRef } from 'react'
import { useGLTF } from '@react-three/drei'

export function Colored(props) {
  const { nodes, materials } = useGLTF('./models/colored6.glb')
  return (
...
useGLTF.preload('./models/colored6.glb')
